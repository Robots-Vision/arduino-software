...
bool fraseCompleta = false;  // whether the string is complete
  ...
  void setup(){    
    ...
    motor2.setSpeed(40);     // Usamos uma bateria de 9v 450mAh, com ela a velocidade ficou boa. Mas dependendo da bateria utilizada a velocidade deverá ser utilizada. Não use pilhas, pois são fracas
 ...
 void pensar(){    
   r eposicionaServoSonar(); //Coloca o servo para olhar a frente    
